permissionset 60000 "DXR MCC"
{
    ...
    Permissions =
        ...
        codeunit "DXR MCC Adapt DRLOC Phase2" = X,
        codeunit "DXR MCC Adapt DRLOC Phase3" = X,
        codeunit "DXR MCC Adapt DRLOC Phase4" = X,
        codeunit "DXR MCC Adapt DRLOC Phase5" = X,
        codeunit "DXR MCC Adapt DRLOC Phase6" = X,
