...
codeunit 60146 "DXR MCC Bellon Migr Phase2"
{
    ...
    // "DXR MCC Master Customer" (60450).ApplyBELLON() - ese codeunit hace un solo recorrido de
    // Customer para los 6 bloques que si migraron (BELLON, BC, DESB, DRLOC, PCM, SD) en vez de
    // uno por extension. No-op deliberado, no se borra: el dispatcher case 'TE-CUSTOMER' y
    // MigrateAllTableExtensionFields() siguen invocandolo.
    ...
    begin
        ...
        // (60451).ApplyBELLON() - ese codeunit hace un solo recorrido de Item para los 5 bloques
        // que si migraron (BC, BELLON, DESB, DRLOC, FE) en vez de uno por extension. No-op
        // deliberado, no se borra: el dispatcher por codigo de concepto ('TE-ITEM') y
        // MigrateAllTableExtensionFields() siguen invocando este procedimiento.
    end;
