...
//     // property at all, despite touching ~130 tables (66 pairs via MigrateLegacyTableData's
//     // RecordRef.Open by ID, plus 45 pairs - and one same-table Legacy/New special case - via typed
//     // Record in the native-converted Setup batches). DXR MCC PermissionSet (60000) only grants
//     // codeunit Execute and MCC's own tabledata, never third-party tabledata, so a per-object
//     // Permissions block is the sole runtime access mechanism in this codebase (see Phase2's own
//     // header comment). Source (59xxx "Old2") tables only need R (FindSet/Next, never modified);
//     // destination (53xxx) tables only need RI (Get + Insert, no Modify anywhere in this codeunit).
//     Permissions =
//         tabledata "DXR_AGR Setup Old2" = R,
//         tabledata "DXR_AGR Setup" = RI,
//         tabledata "DXR_Ajuste Inventario Con Old2" = R,
//         tabledata "DXR_Ajuste Inventario Config" = RI,
//         tabledata "DXR_Area de Trabajo Old2" = R,
//         tabledata "DXR_Area de Trabajo" = RI,
//         tabledata "DXR_Categoria Servicios Old2" = R,
//         tabledata "DXR_Categoria Servicios" = RI,
//         tabledata "DXR_Cilindros - Setup Old2" = R,
//         tabledata "DXR_Cilindros - Setup" = RI,
//         tabledata "DXR_Conf. Extracto Bancar Old2" = R,
//         tabledata "DXR_Conf. Extracto Bancario" = RI,
//         tabledata "DXR_Config. NCF Ventas Old2" = R,
//         tabledata "DXR_Config. NCF Ventas" = RI,
//         tabledata "DXR_Config. NCF Ventas ST Old2" = R,
//         tabledata "DXR_Config. NCF Ventas STD" = RI,
//         tabledata "DXR_Config. Polizas Old2" = R,
//         tabledata "DXR_Config. Polizas" = RI,
//         tabledata "DXR_Configuracion CB Old2" = R,
//         tabledata "DXR_Configuracion CB" = RI,
//         tabledata "DXR_Config Encuestas - PO Old2" = R,
//         tabledata "DXR_Config Encuestas - POS" = RI,
//         tabledata "DXR_Config Req Old2" = R,
//         tabledata "DXR_Config Req" = RI,
//         tabledata "DXR_Configuracion - MEDAL Old2" = R,
//         tabledata "DXR_Configuracion - MEDALLIA" = RI,
//         tabledata "DXR_Conf. Pagos Ecommerce Old2" = R,
//         tabledata "DXR_Conf. Pagos Ecommerce Azul" = RI,
//         tabledata "DXR_Control Proc por Alma Old2" = R,
//         tabledata "DXR_Control Proc por Almacen" = RI,
//         tabledata "DXR_Draw Setup Old2" = R,
//         tabledata "DXR_Draw Setup" = RI,
//         tabledata "DXR_Email Source Tmpl Rel Old2" = R,
//         tabledata "DXR_Email Source Tmpl Rel" = RI,
//         tabledata "DXR_EPagos Setup Old2" = R,
//         tabledata "DXR_EPagos Setup" = RI,
//         tabledata "DXR_Exclude Filter Journa Old2" = R,
//         tabledata "DXR_Exclude Filter Journal" = RI,
//         tabledata "DXR_Excluir Term - ItemSe Old2" = R,
//         tabledata "DXR_Excluir Term - ItemSearch" = RI,
//         tabledata "DXR_File Structure Old2" = R,
//         tabledata "DXR_File Structure" = RI,
//         tabledata "DXR_Forma de Pago Old2" = R,
//         tabledata "DXR_Forma de Pago" = RI,
//         tabledata "DXR_Inventory Masks Old2" = R,
//         tabledata "DXR_Inventory Masks" = RI,
//         tabledata "DXR_Marcas Old2" = R,
//         tabledata "DXR_Marcas" = RI,
//         tabledata "DXR_Member Management Set Old2" = R,
//         tabledata "DXR_Member Management Setup" = RI,
//         tabledata "DXR_Motivo Cierre - Discr Old2" = R,
//         tabledata "DXR_Motivo Cierre - Discr" = RI,
//         tabledata "DXR_Motivo Discrepancia Old2" = R,
//         tabledata "DXR_Motivo Discrepancia" = RI,
//         tabledata "DXR_Profesion Old2" = R,
//         tabledata "DXR_Profesion" = RI,
//         tabledata "DXR_Promotion Setup Old2" = R,
//         tabledata "DXR_Promotion Setup" = RI,
//         tabledata "DXR_Provincia Old2" = R,
//         tabledata "DXR_Provincia" = RI,
//         tabledata "DXR_Sales Dept Old2" = R,
//         tabledata "DXR_Sales Dept" = RI,
//         tabledata "DXR_Sales Groups Old2" = R,
//         tabledata "DXR_Sales Groups" = RI,
//         tabledata "DXR_Sales SubGroups Old2" = R,
//         tabledata "DXR_Sales SubGroups" = RI,
//         tabledata "DXR_Std POS DASCOM Paymt Old2" = R,
//         tabledata "DXR_Std POS DASCOM Paymt Eqv" = RI,
//         tabledata "DXR_Standard POS Gen. Com Old2" = R,
//         tabledata "DXR_Standard POS Gen. Comments" = RI,
//         tabledata "DXR_Standard POS Users Old2" = R,
//         tabledata "DXR_Standard POS Users" = RI,
//         tabledata "DXR_Summary Recon Setup Old2" = R,
//         tabledata "DXR_Summary Recon Setup" = RI,
//         tabledata "DXR_Tasas BC Old2" = R,
//         tabledata "DXR_Tasas BC" = RI,
//         tabledata "DXR_Tipo de Contenedor Old2" = R,
//         tabledata "DXR_Tipo de Contenedor" = RI,
//         tabledata "DXR_Tipo Gas Old2" = R,
//         tabledata "DXR_Tipo Gas" = RI,
//         tabledata "DXR_Tipos o Agentes Old2" = R,
//         tabledata "DXR_Tipos o Agentes" = RI,
//         tabledata "DXR_Tratados Arancelarios Old2" = R,
//         tabledata "DXR_Tratados Arancelarios" = RI,
//         tabledata "DXR_UserApproverByBuyerGr Old2" = R,
//         tabledata "DXR_UserApproverByBuyerGroup" = RI,
//         tabledata "DXR_UserByBuyerGroup Old2" = R,
//         tabledata "DXR_UserByBuyerGroup" = RI,
//         tabledata "DXR_VAT Bus. Settings Old2" = R,
//         tabledata "DXR_VAT Bus. Settings" = RI,
//         tabledata "DXR_Config - Discr" = RI,
//         tabledata "DXR_Agente Old2" = R,
//         tabledata "DXR_Agente" = RI,
//         tabledata "DXR_AGR Log Old2" = R,
//         tabledata "DXR_AGR Log" = RI,
//         tabledata "DXR_Archivo - Discrepanci Old2" = R,
//         tabledata "DXR_Archivo - Discrepancias" = RI,
//         tabledata "DXR_Bancos - Extracto Ban Old2" = R,
//         tabledata "DXR_Bancos - Extracto Bancario" = RI,
//         tabledata "DXR_Bank Old2" = R,
//         tabledata "DXR_Bank" = RI,
//         tabledata "DXR_Bank Relation Old2" = R,
//         tabledata "DXR_Bank Relation" = RI,
//         tabledata "DXR_Black List Promotion Old2" = R,
//         tabledata "DXR_Black List Promotion" = RI,
//         tabledata "DXR_Cabecera Discrepancia Old2" = R,
//         tabledata "DXR_Cabecera Discrepancia" = RI,
//         tabledata "DXR_Carga Masiva Benef BP Old2" = R,
//         tabledata "DXR_Carga Masiva Benef BPD" = RI,
//         tabledata "DXR_Cilindros Old2" = R,
//         tabledata "DXR_Cilindros" = RI,
//         tabledata "DXR_Comentario - Discrepa Old2" = R,
//         tabledata "DXR_Comentario - Discrepancias" = RI,
//         tabledata "DXR_Conversion Costo Old2" = R,
//         tabledata "DXR_Conversion Costo" = RI,
//         tabledata "DXR_Departamento - Discr Old2" = R,
//         tabledata "DXR_Departamento - Discr" = RI,
//         tabledata "DXR_Detalle - Extr Bancar Old2" = R,
//         tabledata "DXR_Detalle - Extr Bancario" = RI,
//         tabledata "DXR_Entrega Fact CxC - Li Old2" = R,
//         tabledata "DXR_Entrega Fact CxC - Lines" = RI,
//         tabledata "DXR_Envio Compras Old2" = R,
//         tabledata "DXR_Envio Compras" = RI,
//         tabledata "DXR_HisCargaMasivaBenefBP Old2" = R,
//         tabledata "DXR_HisCargaMasivaBenefBPD" = RI,
//         tabledata "DXR_Grupo Venta Old2" = R,
//         tabledata "DXR_Grupo Venta" = RI,
//         tabledata "DXR_HisLinCargaMasivaBene Old2" = R,
//         tabledata "DXR_HisLinCargaMasivaBenefBPD" = RI,
//         tabledata "DXR_Hist. Beneficiarios B Old2" = R,
//         tabledata "DXR_Hist. Beneficiarios BPD" = RI,
//         tabledata "DXR_Hist. Cabecera Discr Old2" = R,
//         tabledata "DXR_Hist. Cabecera Discr" = RI,
//         tabledata "DXR_Hist. de Ganadores Old2" = R,
//         tabledata "DXR_Hist. de Ganadores" = RI,
//         tabledata "DXR_Hist. Int Consump. He Old2" = R,
//         tabledata "DXR_Hist. Int Consump. Header" = RI,
//         tabledata "DXR_Hist. Int Consump. Li Old2" = R,
//         tabledata "DXR_Hist. Int Consump. Line" = RI,
//         tabledata "DXR_Hist. Linea Discrepan Old2" = R,
//         tabledata "DXR_Hist. Linea Discrepancia" = RI,
//         tabledata "DXR_Historico Enc Requisi Old2" = R,
//         tabledata "DXR_Historico Enc Requisicion" = RI,
//         tabledata "DXR_Historico - Extr Banc Old2" = R,
//         tabledata "DXR_Historico - Extr Bancario" = RI,
//         tabledata "DXR_Historico Requisicion Old2" = R,
//         tabledata "DXR_Historico Requisicion Line" = RI,
//         tabledata "DXR_Hist Pre-Requisicion Old2" = R,
//         tabledata "DXR_Hist Pre-Requisicion" = RI,
//         tabledata "DXR_Hist PreReq Line Old2" = R,
//         tabledata "DXR_Hist Pre-Requisicion Line" = RI,
//         tabledata "DXR_Int Consump Header Old2" = R,
//         tabledata "DXR_Int Consump Header" = RI,
//         tabledata "DXR_Int. Consump. Line Old2" = R,
//         tabledata "DXR_Internal Consumption Line" = RI,
//         tabledata "DXR_Int. Consump. Log Old2" = R,
//         tabledata "DXR_Internal Consumption Log" = RI,
//         tabledata "DXR_ItemNo Desliquidacion Old2" = R,
//         tabledata "DXR_ItemNo Desliquidacion" = RI,
//         tabledata "DXR_Journal Promotion Tic Old2" = R,
//         tabledata "DXR_Journal Promotion Tickets" = RI,
//         tabledata "DXR_Linea Discrepancia Old2" = R,
//         tabledata "DXR_Linea Discrepancia" = RI,
//         tabledata "DXR_Lin Carga Masiva Ben. Old2" = R,
//         tabledata "DXR_Lin Carga Masiva Ben. BPD" = RI,
//         tabledata "DXR_LineRQBuffer Old2" = R,
//         tabledata "DXR_LineRQBuffer" = RI,
//         tabledata "DXR_Log - Bank Statement Old2" = R,
//         tabledata "DXR_Log - Bank Statement" = RI,
//         tabledata "DXR_Log Email Old2" = R,
//         tabledata "DXR_Log Email" = RI,
//         tabledata "DXR_Log Transaccion Azul Old2" = R,
//         tabledata "DXR_Log Transaccion Azul" = RI,
//         tabledata "DXR_Log Transaccion Medal Old2" = R,
//         tabledata "DXR_Log Transaccion Medallia" = RI,
//         tabledata "DXR_Log Transfer error Old2" = R,
//         tabledata "DXR_Log Transfer error" = RI,
//         tabledata "DXR_Movimientos de Cilind Old2" = R,
//         tabledata "DXR_Movimientos de Cilindro" = RI,
//         tabledata "DXR_Order Item Status Old2" = R,
//         tabledata "DXR_Order Item Status" = RI,
//         tabledata "DXR_Posted Jnl Promo Tick Old2" = R,
//         tabledata "DXR_Posted Jnl Promo Tickets" = RI,
//         tabledata "DXR_Pre Req LineNoStockVa Old2" = R,
//         tabledata "DXR_Pre Req LineNoStockValid" = RI,
//         tabledata "DXR_Pre Req no Stock Vali Old2" = R,
//         tabledata "DXR_Pre Req no Stock Valid" = RI,
//         tabledata "DXR_Pre-Requisicion Old2" = R,
//         tabledata "DXR_Pre-Requisicion" = RI,
//         tabledata "DXR_Pre-Requisicion Line Old2" = R,
//         tabledata "DXR_Pre-Requisicion Line" = RI,
//         tabledata "DXR_Pre-Req Line No Stock Old2" = R,
//         tabledata "DXR_Pre-Req Line No Stock" = RI,
//         tabledata "DXR_Pre-Requisicion no St Old2" = R,
//         tabledata "DXR_Pre-Requisicion no Stock" = RI,
//         tabledata "DXR_Printing Invoice Log Old2" = R,
//         tabledata "DXR_Printing Invoice Log" = RI,
//         tabledata "DXR_Promotion Tickets Rel Old2" = R,
//         tabledata "DXR_Promotion Tickets Relation" = RI,
//         tabledata "DXR_Requisicion Old2" = R,
//         tabledata "DXR_Requisicion" = RI,
//         tabledata "DXR_Requisicion Comment L Old2" = R,
//         tabledata "DXR_Requisicion Comment Line" = RI,
//         tabledata "DXR_Requisicion Line Old2" = R,
//         tabledata "DXR_Requisicion Line" = RI,
//         tabledata "DXR_Send Email Log Old2" = R,
//         tabledata "DXR_Send Email Log" = RI,
//         tabledata "DXR_Store Statement Posti Old2" = R,
//         tabledata "DXR_Store Statement Posting" = RI,
//         tabledata "DXR_Tickets By Offer Old2" = R,
//         tabledata "DXR_Tickets By Offer" = RI,
//         tabledata "DXR_Tickets Entry Old2" = R,
//         tabledata "DXR_Tickets Entry" = RI,
//         tabledata "DXR_Trans. Archive Line Old2" = R,
//         tabledata "DXR_Trans. Archive Line" = RI,
//         tabledata "DXR_UserLogs Old2" = R,
//         tabledata "DXR_UserLogs" = RI,
//         tabledata "DXR_UserPromo Apps Old2" = R,
//         tabledata "DXR_UserPromo Apps" = RI,
//         tabledata "DXR_Valoracion de Inventa Old2" = R,
//         tabledata "DXR_Valoracion de Inventario" = RI,
//         tabledata "DXR_Printing Inv Log BO Old2" = R,
...
//         // Removed 2026-08-27 - the Phase 6 half of the same Master-category stall fixed in
//         // "DXR MCC Bellon Migr Phase2". Neither pair can be moved by MigrateLegacyTableData below:
//         //   * 59290 -> 53360 ("DXR_Item Image View Old2" -> "DXR_Item Image View"): BOTH declare
//         //     LinkedObject = true (verified in Dextra_Bellon Customization_28.3.4.20.app,
//         //     Base\Tables.old2\ItemImageView.Table.al and Base\Tables\ItemImageView.Table.al). A
//         //     LinkedObject table is a link to a SQL Server object, not BC-managed storage, so both
//         //     IDs resolve to the SAME external view - there is no row to restore, and the Insert
//         //     would be issued against a SQL view outside BC transaction control.
//         //   * 59289 -> 53359 ("DXR_Item HTML Old2" -> "DXR_Item HTML"): three BLOB fields (Html,
//         //     "Descripcion Extendida", Caracteristicas). MigrateLegacyTableData copies through
//         //     NewFieldRef.Value := OldFieldRef.Value() with NO CalcFields, which for a BLOB can only
//         //     ever write an empty value - so this call never actually restored the content, it just
//         //     walked the whole table on every run and left the concept permanently gapped.
//         // Concepts BELLON-P6 seq 213/214 are retired in DXR MCC Registry Loader to match, so MCC's
//         // generic fallback stops re-attempting them too.
...
//         MigrateLegacyTableData(59287, 53357); // DXR_Internal Consumption Log restored at true original ID
//         MigrateInventoryMasksOld2Table(); // DXR_Inventory Masks Old2 (59288) -> DXR_Inventory Masks (53358) - native
//         // Removed 2026-08-27 - same two pairs, same reasons as in RunMaster() above (LinkedObject
//         // SQL view / three BLOB fields MigrateLegacyTableData cannot copy without CalcFields).
//         // MigrateLegacyTableData(59289, 53359); // DXR_Item HTML restored at true original ID
//         // MigrateLegacyTableData(59290, 53360); // DXR_Item Image View restored at true original ID
//         MigrateLegacyTableData(59291, 53361); // DXR_ItemNo Desliquidacion restored at true original ID
