codeunit 60012 "DXR MCC Registry Loader"
{
    ...
    begin
        ...
        InsConcept('DRLOC', 'DRLOC-P3', 27, 'Purchase Line Settlement legacy table restore (54139 -> 52193)', 60069, 54139, 52193, 'MA');
        InsConcept('DRLOC', 'DRLOC-P3', 28, 'Purchase WS Settlement legacy table restore (54141 -> 52196)', 60069, 54141, 52196, 'MA');
        InsConcept('DRLOC', 'DRLOC-P3', 29, 'Vendor Withholding Header legacy table restore (54144 -> 52202)', 60069, 54144, 52202, 'MA');
        InsConcept('DRLOC', 'DRLOC-P3', 30, 'Withholding Vendor Lines legacy table restore (54149 -> 52211)', 60069, 54149, 52211, 'MA');
        ...
        InsConcept('DRLOC', 'DRLOC-P6', 76, 'Bank Charges Lines legacy table restore (54110 -> 52128)', 60069, 54110, 52128, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 77, 'Bank Commission Setup legacy table restore (54172 -> 52245)', 60069, 54172, 52245, 'SETUP');
        InsConcept('DRLOC', 'DRLOC-P6', 78, 'Cash Receipt Header legacy table restore (54170 -> 52243)', 60069, 54170, 52243, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 79, 'Cash Receipt Line legacy table restore (54171 -> 52244)', 60069, 54171, 52244, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 80, 'Consumer Sales 607 Buffer legacy table restore (54150 -> 52213)', 60069, 54150, 52213, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 81, 'Customer Withholding Entries legacy table restore (54115 -> 52143, active name shortened to DXR_Cust Withhold Entries)', 60069, 54115, 52143, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 82, 'Customer Withholding Header legacy table restore (54116 -> 52144, active name shortened to DXR_Cust Withhold Header)', 60069, 54116, 52144, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 83, 'Dependencies Metadata legacy table restore (54157 -> 52225)', 60069, 54157, 52225, 'SETUP');
        InsConcept('DRLOC', 'DRLOC-P6', 84, 'Detalle Servicio Adquirido legacy table restore (54154 -> 52219)', 60069, 54154, 52219, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 85, 'DGI API Services legacy table restore (54160 -> 52233)', 60069, 54160, 52233, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 86, 'DGI API Services FindByName legacy table restore (54161 -> 52234)', 60069, 54161, 52234, 'HIST');
        InsConcept('DRLOC', 'DRLOC-P6', 87, 'DGII Temp Table legacy table restore (54162 -> 52235)', 60069, 54162, 52235, 'HIST');
