codeunit 60012 "DXR MCC Registry Loader"
{
    ...
    begin
        ...
        InsExt('RBPD', 'Recaudo BPD', 'e5a19345-02ce-4433-b03b-b1a2136682bf', 910,
            'App identity validated against Recaudo BPD app.json 28.3.2.5. Registered App ID is required so the portfolio Setup permission pass can discover and assign its permission sets.');
        ...
        InsExt('RC', 'Retail Controls', '6e53178d-a25a-4433-9b46-977d98c087fc', 100,
        ...
        InsExt('MAILCON', 'Mail Connector', '63f15820-48e6-4536-a227-f82a4be65eaa', 170,
            'Portfolio order slot 170. App identity validated against Mail Connector app.json 28.3.4.6. Registered even without migration concepts so the Setup permission pass includes every assignable permission set exposed by this installed extension.');
    ...
    begin
        ...
        // Added 2026-09-01: standalone one-time adapter, own Phase/Upgrade Tag, deliberately kept
        // separate from DRLOC-P2/P4's bulk field restores above - see "DXR MCC Fix Customer Fiscal"
        // (60457) header comment for the specific gaps this repairs (Uses NCF/NCF Type/Tipo
        // Identificacion inconsistency left by earlier migration passes, incl. the 2026-09-01
        // case where Uses NCF is already correct but NCF Type is still blank). Ported from
        // T20260824.0006_BODYSHOP_JSANCHEZ, same fix, same dispatcher ID.
    ...
    begin
        ...
        if (CategoryCode = 'HIST') or
           ((ExtCode = 'DRLOC') and (PhaseCode = 'DRLOC-P2') and (SeqNo = 15)) or
           ((ExtCode = 'DESB') and (PhaseCode = 'DESB-P1') and (SeqNo = 29))
        then begin
